!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = "undefined" != typeof globalThis ? globalThis : e || self).Comlink = {})
}(this, (function(e) {
    "use strict";
    /**
   * @license
   ...
   */
    ...
    function c(e, t=globalThis, n=["*"]) {
        t.addEventListener("message", (function r(o) {
            ...
            Promise.resolve(d).catch((e => ({
                ...
                "RELEASE" === l && (t.removeEventListener("message", r),
                u(t),
    ...
    const d = new WeakMap
      , g = "FinalizationRegistry"in globalThis && new FinalizationRegistry((e => {
        const t = (d.get(e) || 0) - 1;
        d.set(e, t),
        0 === t && f(e)
    }
